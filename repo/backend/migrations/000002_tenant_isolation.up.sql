...
ALTER TABLE managed_files      ADD COLUMN IF NOT EXISTS tenant_id TEXT NOT NULL DEFAULT 'default';
...
CREATE INDEX IF NOT EXISTS idx_managed_files_tenant       ON managed_files(tenant_id);
